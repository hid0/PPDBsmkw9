				...
				<form method="post" action="proccess.php?step=2"><br />
					...
					<table class="w3-table w3-border w3-striped w3-container" style="max-width:90%;margin: 0 auto;box-shadow: 0px 10px 20px #eee">
						...
						<tr>
							<td>Tanggal lahir</td>
							<td>
								<input type="text" name="tgl_lahir" placeholder="contoh: 30 Januari 2002" class="w3-input w3-border" required>
							</td>
						</tr>
						<tr>
							<td colspan="2">
								...
								<td>
									<div class="w3-row-padding">
										<div class="w3-quarter">
											...
											<input type="text" name="bindo" class="w3-input w3-border ">
										</div>
										<div class="w3-quarter">
											<label>Bahasa Inggris</label>
											<input type="text" name="bing" class="w3-input w3-border ">
										</div>
										<div class="w3-quarter">
											<label>Matematika</label>
											<input type="text" name="mtk" class="w3-input w3-border ">
										</div>
										<div class="w3-quarter">
											<label>IPA</label>
											<input type="text" name="ipa" class="w3-input w3-border ">
										</div>
									</div>
								</td>
							</tr>
