...
if (!empty($_GET['step'])) {
	if ($_GET['step'] == '1') {
		...
		$tgl_dftr = $core->filter_xss(date('Y-m-d'));
		...
		if ($check > 0) {
			...
			$_SESSION['pwuser'] = $pw;
			$data = array('', $jenis_daftar, $tgl_dftr, $jalur, $jl_khusus, $jurusan1, $jurusan2, $asal_sekolah, $alamat_asal, $no_nik, $mk_pw, $p_akademik, $p_nonakademik, 'tidak');
