...
?>
	...
	<tr><td>
			...
			<small><font color=red>*</font><i>Pilihan jika kompetensi keahlian 1 mencapai batas kuota (sudah penuh)</i></small>
		</td><td>
			<select class="w3-input w3-border" name="jurusan2">
				<option>PILIH JURUSAN</option>
				<option value="KT">KRIYA TEKSTIL</option>
				<option value="TKR">TEKNIK KENDARAAN RINGAN</option>
				<option value="TKJ">TEKNIK KOMPUTER JARINGAN</option>
	...
	<tr><td>
		...
		<br><small><font color=red>*</font><i>NIK dapat dilihat pada Kartu Keluarga</i></small>
	</td><td>
		<input type="number" name="no_nik" minlength="16" class="w3-input w3-border" placeholder="332002**********" required>
	</td></tr>
	<tr><td>
		Prestasi akademik
		<br><small><font color=red>*</font><i>Pisahkan dengan tanda koma ( , ) atau titik koma ( ; ) jika terdapat lebih dari satu prestasi</i></small>
	</td><td>
	...
	<tr><td colspan="2"><input type="submit" name="sbmt" value="Selanjutnya" class="w3-btn w3-teal w3-right"></td></tr>
	</table></form>
...
<tr><td colspan="2">
  ...
  <div class="w3-third">
	...
	<tr><td>Tempat tinggal</td>
		...
		<tr><td>Moda transportasi</td>
			...
			<tr><td>Nomor Hp.</td>
				<td><input type="number" name="hp" placeholder="dapat menerima sms, boleh nomor milik orang tua atau suadara" class="w3-input w3-border" required></td></tr>
			<tr><td>Email</td>
				<td><input type="email" name="email" placeholder="your@email.com" class="w3-input w3-border" ></td></tr>
			<tr><td>Nama ayah</td>
				<td><input type="text" name="nama_ayah" placeholder="nama ayah" class="w3-input w3-border" required></td></tr>
			<tr><td>Pekerjaan ayah</td>
				<td><input type="text" name="pekerjaan_ayah" placeholder="pekerjaan ayah" class="w3-input w3-border" ></td></tr>
			<tr><td>Nama ibu</td>
				<td><input type="text" name="nama_ibu" placeholder="nama ibu" class="w3-input w3-border" required></td></tr>
			<tr><td>Pekerjaan ibu</td>
				<td><input type="text" name="pekerjaan_ibu" placeholder="pekerjaan ibu" class="w3-input w3-border"></td></tr>
			<tr><td>Nama wali</td>
				<td><input type="text" name="nama_wali" placeholder="nama wali" class="w3-input w3-border" ></td></tr>
			<tr><td>Pekerjaan wali</td>
				<td><input type="text" name="pekerjaan_wali" placeholder="pekerjaan wali" class="w3-input w3-border" ></td></tr>
			<tr><td colspan="2">
					<div class="w3-row-padding">
  <div class="w3-half">
    <label>Anak ke</label>
  ...
  <div class="w3-half">
	...
	<tr><td colspan="2">
		<input type="submit" name="sbmt" value="Selanjutnya" class="w3-btn w3-teal w3-right"></td></tr>
	</table>
			<?php
		}elseif($_GET['a'] == 'step3')
		{
	...
	<table class="w3-table w3-border w3-striped w3-container" style="max-width:90%;margin: 0 auto;box-shadow: 0px 10px 20px #eee">
		...
		<tr><td>Apakah anda merokok?</td><td>
		...
		<tr><td>Apakah anda bertato?</td><td>
		...
		<tr><td>Apakah anda berkebutuhan khusus?</td><td>
		...
		<tr><td>Apakah anda buta warna?</td><td>
		...
		<tr><td>Darimana Anda mendapatkan informasi tentang SMK Walisongo?</td><td>
		...
		<tr><td>Yang menyarankan Anda untuk mendaftar di SMK Walisongo?</td><td>
